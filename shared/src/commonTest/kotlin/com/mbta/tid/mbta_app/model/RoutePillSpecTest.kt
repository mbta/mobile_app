...
class RoutePillSpecTest {
    ...
    fun `test shuttle`() {
        ...
        val rlShuttleFlexCompact = RoutePillSpec(rlShuttle, redLine, RoutePillSpec.Type.FlexCompact)
        ...
        val glShuttleFlexCompact =
            RoutePillSpec(glShuttle, greenLine, RoutePillSpec.Type.FlexCompact)
