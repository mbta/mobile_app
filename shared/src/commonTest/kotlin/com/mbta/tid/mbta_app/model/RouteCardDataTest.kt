...
class RouteCardDataTest {
                                        ...
                                        mapOf(
                                            0 to
                                                RouteCardData.LeafBuilder(
                                                    ...
                                                    stop = stop,
                                                    direction = Direction(0, shuttleRoute),
                                    ...
                                    mapOf(
                                        0 to
                                            RouteCardData.LeafBuilder(
                                                lineOrRoute = lineOrRoute,
                                                stop = parkSt,
                                                direction = Direction("West", null, 0),
                                                routePatterns =
                                                    listOf(
                                                        bWestPattern,
                                                        cWestPattern,
                            ...
                            RouteCardData.RouteStopData(
                                ...
                                listOf(
                                    RouteCardData.Leaf(
                                        lineOrRoute = subwayLineOrRoute,
                                        stop = subwayStop,
                                        direction = Direction(0, subwayRoute),
                            ...
                            RouteCardData.RouteStopData(
                                ...
                                listOf(
                                    RouteCardData.Leaf(
                                        lineOrRoute = busLineOrRoute,
                                        stop = busStop,
                                        direction = Direction(0, busRoute),
                                ...
                                RouteCardData.RouteStopData(
                                    ...
                                    listOf(
                                        RouteCardData.Leaf(
                                            lineOrRoute = subwayLineOrRoute2,
                                            stop = closerStop,
                                            direction = Direction(0, subwayRoute2),
                                ...
                                RouteCardData.RouteStopData(
                                    ...
                                    listOf(
                                        RouteCardData.Leaf(
                                            lineOrRoute = subwayLineOrRoute1,
                                            stop = furtherStop,
                                            direction = Direction(0, subwayRoute1),
    ...
    @Test
    fun `RouteCardData routeCardsForStopList sorts close bus first then subway then by distance`() =
        runBlocking {
            val objects = ObjectCollectionBuilder()
            ...
            val midBusPattern =
                objects.routePattern(midBusRoute) { representativeTrip { headsign = "Lechmere" } }
            val farBusPattern =
            ...
            objects.prediction {
                ...
                tripId = midBusPattern.representativeTripId
            }
                ...
                GlobalResponse(
                    ...
                    patternIdsByStop =
                        mapOf(
                            ...
                            midBusStop.id to listOf(midBusPattern.id),
            ...
            assertEquals(
                listOf(closeBusRoute, closeSubwayRoute, farSubwayRoute, midBusRoute, farBusRoute),
        ...
        runBlocking {
            ...
            val routeCardsSorted =
                RouteCardData.routeCardsForStopList(
                    ...
                    global,
                    sortByDistanceFrom = terminalStop.position,
                    schedules = ScheduleResponse(objects),
                    predictions = PredictionsStreamDataResponse(objects),
                    alerts = AlertsStreamDataResponse(objects),
                    now = time,
                            ...
                            RouteCardData.RouteStopData(
                                ...
                                listOf(
                                    RouteCardData.Leaf(
                                        lineOrRoute = orangeLineOrRoute,
                                        stop = northStation,
                                        direction = Direction(0, orangeRoute),
                                        routePatterns =
                                            listOf(
                            ...
                            RouteCardData.RouteStopData(
                                ...
                                listOf(
                                    RouteCardData.Leaf(
                                        lineOrRoute = ferryLineOrRoute,
                                        stop = longWharf,
                                        direction = Direction(0, ferryRoute),
