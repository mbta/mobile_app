...
/** Durations become opaque Int64s in Swift, so this class represents a Kotlin Duration in a way that’s legible and constructible from Swift */
public class KotlinDuration(public val duration: Duration) {
    @DefaultArgumentInterop.Enabled public constructor(days: Int = 0, hours: Int = 0, minutes: Int = 0, seconds: Int = 0) : this(days.days + hours.hours + minutes.minutes + seconds.seconds)
