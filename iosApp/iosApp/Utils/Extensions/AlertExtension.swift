...
extension Alert.Effect {
    var effectSentenceCaseString: String {
        ...
        case .stationClosure: NSLocalizedString("Stop skipped", comment: "Possible alert effect")
        case .stationIssue: NSLocalizedString("Station issue", comment: "Possible alert effect")
        case .stopClosure: NSLocalizedString("Stop skipped", comment: "Possible alert effect")
