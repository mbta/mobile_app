...
fun FavoriteConfirmationDialog(
    ...
    desiredFavorites: Map<Int, Boolean>,
    toggleFavorite: (RouteStopDirection) -> Unit,
    onClose: () -> Unit,
) {

    val favoritesToSave = remember { desiredFavorites.toMutableMap() }
    ...
    Dialog(onDismissRequest = {}) {
        Card(modifier = Modifier.fillMaxWidth()) {
                    ...
                    directions.map { direction ->
                        Button(
                            ...
                            Row(
                                ...
                                PinButton(
                                    favoritesToSave.contains(direction.id),
            ...
            Row() {
                ...
                Button(
                    {
                        // TODO: Save favorites w/out toggle
                        onClose()
                    },
    ...
    MyApplicationTheme {
        Column(Modifier.background(colorResource(R.color.fill3))) {
            FavoriteConfirmationDialog(
                ...
                desiredFavorites = mapOf(0 to true, 1 to false),
                toggleFavorite = {},
                onClose = {},
            )
        }
